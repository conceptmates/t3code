...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.launchListConfigs]: AuthOrchestrationReadScope,
  // Running a configuration starts a process, like opening a terminal.
  [WS_METHODS.launchRun]: AuthTerminalOperateScope,
  [WS_METHODS.launchStop]: AuthTerminalOperateScope,
  [WS_METHODS.launchStarters]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.vcsCommitGraph]: AuthOrchestrationReadScope,
  [WS_METHODS.vcsCommitFiles]: AuthOrchestrationReadScope,
  [WS_METHODS.vcsCommitPatch]: AuthOrchestrationReadScope,
  [WS_METHODS.vcsWorkingCopyStatus]: AuthOrchestrationReadScope,
  // Staging and committing mutate the repository, same as switching a ref.
  [WS_METHODS.vcsStage]: AuthOrchestrationOperateScope,
  [WS_METHODS.vcsCommit]: AuthOrchestrationOperateScope,
  // Spends provider tokens, so it needs more than read access.
  [WS_METHODS.vcsSuggestCommitMessage]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.deviceAdbPair]: AuthOrchestrationOperateScope,
