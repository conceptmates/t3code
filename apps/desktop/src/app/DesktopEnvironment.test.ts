    ...
    Effect.gen(function* () {
      const environment = yield* makeEnvironment(
        {},
        {
          ...
          T3CODE_SSH_REMOTE_VERSION: " 0.0.41-nightly.20260914.1707 ",
          T3CODE_RELEASE_BASE_URL: " https://mirror.example/t3 ",
      ...
      assert.deepEqual(environment.sshRemoteVersion, Option.some("0.0.41-nightly.20260914.1707"));
      assert.deepEqual(environment.releaseBaseUrl, Option.some("https://mirror.example/t3"));
