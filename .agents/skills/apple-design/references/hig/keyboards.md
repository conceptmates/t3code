...
| ------------ | ------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Command      | _image: Keyboard Command_ | Prefer the Command key as the main modifier key in a custom keyboard shortcut.                                                                            |
| Shift        | _image: Keyboard Shift_   | Prefer the Shift key as a secondary modifier that complements a related shortcut.                                                                         |
| Option       | _image: Keyboard Option_  | Use the Option modifier sparingly for less-common commands or power features.                                                                             |
| Control      | _image: Keyboard Control_ | Avoid using the Control key as a modifier. The system uses Control in many systemwide features and shortcuts, like moving focus or capturing screenshots. |
