...
You can design interface icons — also called _glyphs_ — or you can choose symbols from the SF Symbols app, using them as-is or customizing them to suit your needs. Both interface icons and symbols use black and clear colors to define their shapes; the system can apply other colors to the black areas in each image. For guidance, see [SF Symbols](sf-symbols.md).
...
| --------- | --------------------------------------------- | ----------------------- |
| Cut       | _image: icons symbols meaning cut_            | `scissors`              |
| Copy      | _image: icons symbols meaning copy_           | `document.on.document`  |
| Paste     | _image: icons symbols meaning paste_          | `document.on.clipboard` |
| Done      | _image: icons symbols meaning done save_      | `checkmark `            |
| Save      | _image: icons symbols meaning done save_      | `checkmark `            |
| Cancel    | _image: icons symbols meaning close cancel_   | `xmark`                 |
| Close     | _image: icons symbols meaning close cancel_   | `xmark`                 |
| Delete    | _image: icons symbols meaning delete_         | `trash`                 |
| Undo      | _image: icons symbols meaning undo_           | `arrow.uturn.backward`  |
| Redo      | _image: icons symbols meaning redo_           | `arrow.uturn.forward`   |
| Compose   | _image: icons symbols meaning compose_        | `square.and.pencil`     |
| Duplicate | _image: icons symbols meaning duplicate_      | `plus.square.on.square` |
| Rename    | _image: icons symbols meaning rename_         | `pencil`                |
| Move to   | _image: icons symbols meaning move to folder_ | `folder`                |
| Folder    | _image: icons symbols meaning move to folder_ | `folder`                |
| Attach    | _image: icons symbols meaning attach_         | `paperclip`             |
| Add       | _image: icons symbols meaning add_            | `plus`                  |
| More      | _image: icons symbols meaning more_           | `ellipsis`              |

### Selection

| Action   | Icon                                          | Symbol name        |
| -------- | --------------------------------------------- | ------------------ |
| Select   | _image: icons symbols meaning select all_     | `checkmark.circle` |
| Deselect | _image: icons symbols meaning deselect close_ | `xmark`            |
| Close    | _image: icons symbols meaning deselect close_ | `xmark`            |
| Delete   | _image: icons symbols meaning delete_         | `trash`            |
...
| Action       | Icon                                           | Symbol name              |
| ------------ | ---------------------------------------------- | ------------------------ |
| Superscript  | _image: icons symbols meaning superscript_     | `textformat.superscript` |
| Subscript    | _image: icons symbols meaning subscript_       | `textformat.subscript`   |
| Bold         | _image: icons symbols meaning bold_            | `bold`                   |
| Italic       | _image: icons symbols meaning italic_          | `italic`                 |
| Underline    | _image: icons symbols meaning underline_       | `underline`              |
| ​​Align Left | _image: icons symbols meaning align left_      | `text.alignleft`         |
| Center       | _image: icons symbols meaning align center_    | `text.aligncenter`       |
| Justified    | _image: icons symbols meaning align justified_ | `text.justify`           |
| Align Right  | _image: icons symbols meaning align right_     | `text.alignright`        |

### Search

| Action                 | Icon                                  | Symbol name                       |
| ---------------------- | ------------------------------------- | --------------------------------- |
| Search                 | _image: icons symbols meaning search_ | `magnifyingglass`                 |
| Find                   | _image: icons symbols meaning find_   | `text.page.badge.magnifyingglass` |
| Find and Replace       | _image: icons symbols meaning find_   | `text.page.badge.magnifyingglass` |
| Find Next              | _image: icons symbols meaning find_   | `text.page.badge.magnifyingglass` |
| Find Previous          | _image: icons symbols meaning find_   | `text.page.badge.magnifyingglass` |
| Use Selection for Find | _image: icons symbols meaning find_   | `text.page.badge.magnifyingglass` |
| Filter                 | _image: icons symbols meaning filter_ | `line.3.horizontal.decrease`      |

### Sharing and exporting

| Action | Icon                                   | Symbol name           |
| ------ | -------------------------------------- | --------------------- |
| Share  | _image: icons symbols meaning sharing_ | `square.and.arrow.up` |
| Export | _image: icons symbols meaning sharing_ | `square.and.arrow.up` |
| Print  | _image: icons symbols meaning print_   | `printer`             |

### Users and accounts

| Action  | Icon                                        | Symbol name          |
| ------- | ------------------------------------------- | -------------------- |
| Account | _image: icons symbols meaning account user_ | `person.crop.circle` |
| User    | _image: icons symbols meaning account user_ | `person.crop.circle` |
| Profile | _image: icons symbols meaning account user_ | `person.crop.circle` |

### Ratings

| Action  | Icon                                   | Symbol name       |
| ------- | -------------------------------------- | ----------------- |
| Dislike | _image: icons symbols meaning dislike_ | `hand.thumbsdown` |
| Like    | _image: icons symbols meaning like_    | `hand.thumbsup`   |

### Layer ordering

| Action         | Icon                                          | Symbol name                        |
| -------------- | --------------------------------------------- | ---------------------------------- |
| Bring to Front | _image: icons symbols meaning bring to front_ | `square.3.layers.3d.top.filled`    |
| Send to Back   | _image: icons symbols meaning send to back_   | `square.3.layers.3d.bottom.filled` |
| Bring Forward  | _image: icons symbols meaning bring forward_  | `square.2.layers.3d.top.filled`    |
| Send Backward  | _image: icons symbols meaning send backwards_ | `square.2.layers.3d.bottom.filled` |

### Other

| Action   | Icon                                    | Symbol name  |
| -------- | --------------------------------------- | ------------ |
| Alarm    | _image: icons symbols meaning alarm_    | `alarm`      |
| Archive  | _image: icons symbols meaning archive_  | `archivebox` |
| Calendar | _image: icons symbols meaning calendar_ | `calendar`   |
