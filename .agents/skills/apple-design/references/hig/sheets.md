...
In macOS, tvOS, visionOS, and watchOS, a sheet is always _modal_. A modal sheet presents a targeted experience that prevents people from interacting with the parent view until they dismiss the sheet (for more on modal presentation, see [Modality](modality.md)).
...
_Illustrated: First step, Subsequent step, Final step._
