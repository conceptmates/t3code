...
_Illustrated: Full screen, Windowed._
...
The _frame_ of a window appears above the body area and can include window controls and a [toolbar](toolbars.md). In rare cases, a window can also display a bottom bar, which is a part of the frame that appears below body content.
