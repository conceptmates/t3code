...
- The _sheet_ style displays a place card in a [sheet](sheets.md).
...
_Illustrated: Full callout, Compact callout, Caption, Sheet._
...
_Illustrated: Example 1, Example 2, Example 3._
