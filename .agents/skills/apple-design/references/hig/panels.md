...
In general, a panel has a less prominent appearance than an app’s [main window](windows.md#macos-window-states). When the situation calls for it, a panel can also use a dark, translucent style to support a heads-up display (or _HUD_) experience.
